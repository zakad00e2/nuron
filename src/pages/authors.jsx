...
const API_AUTHORS_URL = "https://brilliant-boot-036dae9a94.strapiapp.com/api/authors";
...
const AuthorsPage = () => {
    ...
    useEffect(() => {
        const fetchAuthors = async () => {
            setLoading(true);
            try {
                const response = await fetch(`${API_AUTHORS_URL}?locale=${language}&populate=photo`);
